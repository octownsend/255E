...
# Create a function to download tide data from the NOAA website with a pre-selected tide station and date range
...
The function includes appropriate axis labels, gridlines, and formatted title (month spelled out and 4-digit year). 
...
plotTides<-function(df){
  ...
  plot(x = df$TimeUTC,y = df$TideHT,type = 'l',xlab = "Date (month, day)",ylab = "Tide Height  (m)",col="blue",main = date)
  grid(nx=NA,ny=NULL,col = "darkgray")
}

```

# Let's plot tide data for August, September, and October 2016 from the Monterey Station

## First import the data using NOAAfunction
Assign a data frame for each month: "aug" for August, "sept" for September, "oct" for October.

```{r grabmonths, cache=TRUE}
aug=NOAAfunction(9413450,20160801,20160831)

sept=NOAAfunction(9413450,20160901,20160930)

oct=NOAAfunction(9413450,20161001,20161031)
```

## Then create the plots using plotTides
