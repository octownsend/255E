...
plotTides<-function(df){
  plot(x = df$TimeUTC,y = df$TideHT,type = 'l',xlab = "Date",ylab = "Tide Height (m)",col="blue")
}

```

```{r grabmonths, cache=TRUE}
#assign data frame for January 2010, call it jan
jan=NOAAfunction(9413450,20100101,20100131)

#data frame feb for February 2010
feb=NOAAfunction(9413450,20100201,20100228)

#data frame march for March 2010
march=NOAAfunction(9413450,20100301,20100331)
```

```{r plotmonths}
#plot tide data for all 3 months
plotTides(jan)
plotTides(feb)
plotTides(march)
```
